...
void parameterCheck(TreeNode * tree, SymbolTable *table)
{
    ...
    if(tree->child[0] != NULL && temp->child[0] != NULL)
    {
        //temp is the function found in the table
        TreeNode * passed = tree->child[0];
        TreeNode * expected = temp->child[0];
        int i = 0;
