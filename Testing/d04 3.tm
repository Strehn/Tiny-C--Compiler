...
* OP  or
 ...
 50:     OR  3,4,3	Op | 
* Param  1
 51:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  outputb
 52:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* OP  and
 57:     LD  4,-13(1)	Pop left into ac1 
 58:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
...
* OP  or
 ...
 84:     OR  3,4,3	Op | 
* Param  4
 85:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  outputb
 86:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 90:     ST  1,-11(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
102:     ST  1,-11(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -12
* TOFF dec:  -13
* Param end  outnl
103:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* OP  and
114:     LD  4,-16(1)	Pop left into ac1 
115:    AND  3,4,3	Op & 
* OP  or
116:     LD  4,-16(1)	Pop left into ac1 
117:     OR  3,4,3	Op | 
* Param  6
118:     ST  3,-16(1)	Push parameter 
* TOFF dec:  -17
* Param end  outputb
119:    LDA  1,-14(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
123:     ST  1,-14(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -15
* TOFF dec:  -16
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  or
126:     LD  4,-16(1)	Pop left into ac1 
127:     OR  3,4,3	Op | 
* Param  7
...
* EXPRESSION
* CALL  outputb
133:     ST  1,-14(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -15
* TOFF dec:  -16
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
136:     LD  4,-16(1)	Pop left into ac1 
137:    AND  3,4,3	Op & 
* OP  or
138:     LD  4,-16(1)	Pop left into ac1 
139:     OR  3,4,3	Op | 
* Param  8
...
* EXPRESSION
* CALL  outputb
157:     ST  1,-14(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -15
* TOFF dec:  -16
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
160:     LD  4,-16(1)	Pop left into ac1 
161:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
...
* EXPRESSION
* CALL  outnl
169:     ST  1,-14(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -15
* TOFF dec:  -16
* Param end  outnl
170:    LDA  1,-14(1)	Ghost frame becomes new active frame 
