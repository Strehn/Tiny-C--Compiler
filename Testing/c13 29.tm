...
* ASSIGN  =
 ...
 41:     ST  3,-302(1)	Store variable z
* EXPRESSION
* EXPRESSION
* EXPRESSION
* ASSIGN  =
 42:     ST  3,-2(1)	Push index 
 43:    LDC  3,73(6)	Load integer constant 
 44:     LD  4,-2(1)	Pop index 
 45:    LDA  5,-2(1)	Load address of base of array x
...
* ASSIGN  =
 ...
 60:     ST  3,-302(1)	Store variable z
* EXPRESSION
* EXPRESSION
* EXPRESSION
* ASSIGN  =
 ...
 64:    LDA  5,-2(1)	Load address of base of array x
...
* ASSIGN  =
 ...
 68:     ST  3,-302(1)	Store variable z
* EXPRESSION
* EXPRESSION
* EXPRESSION
* ASSIGN  =
 ...
 71:     LD  4,-2(1)	Pop index 
 72:    LDA  5,-2(1)	Load address of base of array x
...
* EXPRESSION
* CALL  outnl
 81:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
...
* EXPRESSION
* CALL  outnl
 92:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
...
* EXPRESSION
* CALL  outnl
103:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
104:    LDA  1,-2(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
108:     ST  1,-2(1)	Store fp in ghost frame for  output
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
109:     ST  3,-4(1)	Push parameter 
* TOFF dec: 
* Param end  output
110:    LDA  1,-2(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
119:     ST  1,-2(1)	Store fp in ghost frame for  output
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
125:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
...
* EXPRESSION
* CALL  outnl
147:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
...
* OP  (null)
* Param 
164:     ST  3,-4(1)	Push parameter 
* TOFF dec: 
* Param end  output
165:    LDA  1,-2(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
169:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
...
* EXPRESSION
* CALL  outnl
180:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
181:    LDA  1,-2(1)	Ghost frame becomes new active frame 
...
* =========================================
* INIT
189:    LDA  1,-300(0)	Set first frame at end of globals 
