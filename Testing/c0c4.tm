...
* ASSIGN  =
 ...
 64:     LD  4,0(0)	Load lhs variable  x
 65:     ST  3,-2(1)	Store variable x
* EXPRESSION
* EXPRESSION
* Param 
 66:     ST  3,-11(1)	Push parameter 
* TOFF dec: 
* Param end  outputc
 67:    LDA  1,-7(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputc
 71:     ST  1,-7(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
* Param 
...
* EXPRESSION
* CALL  outputc
 78:     ST  1,-7(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
* Param 
 79:     LD  3,-2(1)	Load variable  y
 80:     ST  3,-9(1)	Push parameter 
* TOFF dec: 
* Param end  outputc
...
* EXPRESSION
* CALL  outputc
 85:     ST  1,-7(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
* Param 
 86:     LD  3,-2(1)	Load variable  z
