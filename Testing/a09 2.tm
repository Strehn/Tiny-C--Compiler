...
* EXPRESSION
* ASSIGN  =
 40:    LDC  3,88(6)	Load char constant 
 41:     ST  3,0(0)	Store variable x
* EXPRESSION
* EXPRESSION
* EXPRESSION
* ASSIGN  =
 42:    LDC  3,89(6)	Load char constant 
 43:     ST  3,-2(1)	Store variable y
* EXPRESSION
* EXPRESSION
* EXPRESSION
* CALL  outputc
 44:     ST  1,-8(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* Param  1
 45:     LD  3,0(0)	Load variable  x
 46:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  outputc
 47:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 51:     ST  1,-8(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -9
* TOFF dec:  -10
* Param end  outnl
...
* EXPRESSION
* CALL  outputc
 56:     ST  1,-8(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* Param  2
 57:     LD  3,-2(1)	Load variable  y
 58:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  outputc
 59:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 63:     ST  1,-8(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -9
* TOFF dec:  -10
* Param end  outnl
