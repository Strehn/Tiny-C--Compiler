...
* OP  +
 ...
 63:    ADD  3,4,3	Op + 
* Param  2
 64:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
 65:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 69:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  output
 79:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  /
 80:     LD  4,-13(1)	Pop left into ac1 
 81:    DIV  3,4,3	Op / 
* EXPRESSION
* OP  /
 ...
 83:    DIV  3,4,3	Op / 
* Param  4
 84:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
 85:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 89:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  *
 90:     LD  4,-13(1)	Pop left into ac1 
 91:    MUL  3,4,3	Op * 
* EXPRESSION
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  %
102:     LD  4,-13(1)	Pop left into ac1 
103:    MOD  3,4,3	Op % 
* EXPRESSION
* OP  %
...
105:    MOD  3,4,3	Op % 
* Param  6
106:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
107:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
111:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
114:    MUL  3,4,3	Op * 
* OP  +
115:     LD  4,-13(1)	Pop left into ac1 
116:    ADD  3,4,3	Op + 
* Param  7
117:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
118:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
122:     ST  1,-11(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -12
* TOFF dec:  -13
* Param end  outnl
123:    LDA  1,-11(1)	Ghost frame becomes new active frame 
