...
* OP  and
 ...
 54:    AND  3,4,3	Op & 
* OP  or
 55:     LD  4,-15(1)	Pop left into ac1 
 56:     OR  3,4,3	Op | 
* Param  1
 57:     ST  3,-15(1)	Push parameter 
* TOFF dec:  -16
* Param end  outputb
 58:    LDA  1,-13(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 62:     ST  1,-13(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -14
* TOFF dec:  -15
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  <=
 65:     LD  4,-15(1)	Pop left into ac1 
 66:    TLE  3,4,3	Op <= 
* OP  and
...
* EXPRESSION
* OP  >=
 85:     LD  4,-15(1)	Pop left into ac1 
 86:    TGE  3,4,3	Op >= 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
 87:     LD  4,-15(1)	Pop left into ac1 
 88:    TGE  3,4,3	Op >= 
* OP  and
 89:     LD  4,-15(1)	Pop left into ac1 
 90:    AND  3,4,3	Op & 
* OP  or
 91:     LD  4,-15(1)	Pop left into ac1 
 92:     OR  3,4,3	Op | 
* Param  3
 93:     ST  3,-15(1)	Push parameter 
* TOFF dec:  -16
* Param end  outputb
 94:    LDA  1,-13(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 98:     ST  1,-13(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -14
* TOFF dec:  -15
* EXPRESSION
* EXPRESSION
...
106:    TGE  3,4,3	Op >= 
* OP  and
107:     LD  4,-15(1)	Pop left into ac1 
108:    AND  3,4,3	Op & 
* OP  or
109:     LD  4,-15(1)	Pop left into ac1 
110:     OR  3,4,3	Op | 
* Param  4
111:     ST  3,-15(1)	Push parameter 
* TOFF dec:  -16
* Param end  outputb
112:    LDA  1,-13(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
116:     ST  1,-13(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -14
* TOFF dec:  -15
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >
117:     LD  4,-15(1)	Pop left into ac1 
118:    TGT  3,4,3	Op > 
* OP  not
...
122:    TLE  3,4,3	Op <= 
* OP  and
123:     LD  4,-15(1)	Pop left into ac1 
124:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
125:     LD  4,-15(1)	Pop left into ac1 
126:    TGE  3,4,3	Op >= 
* OP  or
127:     LD  4,-15(1)	Pop left into ac1 
128:     OR  3,4,3	Op | 
* Param  5
129:     ST  3,-15(1)	Push parameter 
* TOFF dec:  -16
* Param end  outputb
130:    LDA  1,-13(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
134:     ST  1,-13(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -14
* TOFF dec:  -15
* Param end  outnl
...
151:    TGE  3,4,3	Op >= 
* OP  and
152:     LD  4,-18(1)	Pop left into ac1 
153:    AND  3,4,3	Op & 
* OP  or
154:     LD  4,-18(1)	Pop left into ac1 
155:     OR  3,4,3	Op | 
* Param  6
156:     ST  3,-18(1)	Push parameter 
* TOFF dec:  -19
* Param end  outputb
157:    LDA  1,-16(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
161:     ST  1,-16(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -17
* TOFF dec:  -18
* EXPRESSION
* EXPRESSION
...
165:    TLE  3,4,3	Op <= 
* OP  and
166:     LD  4,-18(1)	Pop left into ac1 
167:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
168:     LD  4,-18(1)	Pop left into ac1 
169:    TGE  3,4,3	Op >= 
* OP  or
170:     LD  4,-18(1)	Pop left into ac1 
171:     OR  3,4,3	Op | 
* Param  7
172:     ST  3,-18(1)	Push parameter 
* TOFF dec:  -19
* Param end  outputb
173:    LDA  1,-16(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
177:     ST  1,-16(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -17
* TOFF dec:  -18
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >=
186:     LD  4,-18(1)	Pop left into ac1 
187:    TGE  3,4,3	Op >= 
* OP  and
188:     LD  4,-18(1)	Pop left into ac1 
189:    AND  3,4,3	Op & 
* OP  or
190:     LD  4,-18(1)	Pop left into ac1 
191:     OR  3,4,3	Op | 
* Param  8
192:     ST  3,-18(1)	Push parameter 
* TOFF dec:  -19
* Param end  outputb
193:    LDA  1,-16(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
197:     ST  1,-16(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -17
* TOFF dec:  -18
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >=
204:     LD  4,-18(1)	Pop left into ac1 
205:    TGE  3,4,3	Op >= 
* OP  and
206:     LD  4,-18(1)	Pop left into ac1 
207:    AND  3,4,3	Op & 
* OP  or
208:     LD  4,-18(1)	Pop left into ac1 
209:     OR  3,4,3	Op | 
* Param  9
210:     ST  3,-18(1)	Push parameter 
* TOFF dec:  -19
* Param end  outputb
211:    LDA  1,-16(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
215:     ST  1,-16(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -17
* TOFF dec:  -18
* EXPRESSION
* EXPRESSION
...
221:    TLE  3,4,3	Op <= 
* OP  and
222:     LD  4,-18(1)	Pop left into ac1 
223:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
224:     LD  4,-18(1)	Pop left into ac1 
225:    TGE  3,4,3	Op >= 
* OP  or
226:     LD  4,-18(1)	Pop left into ac1 
227:     OR  3,4,3	Op | 
* Param  10
228:     ST  3,-18(1)	Push parameter 
* TOFF dec:  -19
* Param end  outputb
229:    LDA  1,-16(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
233:     ST  1,-16(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -17
* TOFF dec:  -18
* Param end  outnl
234:    LDA  1,-16(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
244:     ST  1,-19(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -20
* TOFF dec:  -21
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >
245:     LD  4,-21(1)	Pop left into ac1 
246:    TGT  3,4,3	Op > 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  <=
247:     LD  4,-21(1)	Pop left into ac1 
248:    TLE  3,4,3	Op <= 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
249:     LD  4,-21(1)	Pop left into ac1 
250:    TGE  3,4,3	Op >= 
* OP  and
251:     LD  4,-21(1)	Pop left into ac1 
252:    AND  3,4,3	Op & 
* OP  or
253:     LD  4,-21(1)	Pop left into ac1 
254:     OR  3,4,3	Op | 
* Param  11
255:     ST  3,-21(1)	Push parameter 
* TOFF dec:  -22
* Param end  outputb
256:    LDA  1,-19(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
260:     ST  1,-19(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -20
* TOFF dec:  -21
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >
261:     LD  4,-21(1)	Pop left into ac1 
262:    TGT  3,4,3	Op > 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  <=
263:     LD  4,-21(1)	Pop left into ac1 
264:    TLE  3,4,3	Op <= 
* OP  and
265:     LD  4,-21(1)	Pop left into ac1 
266:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
267:     LD  4,-21(1)	Pop left into ac1 
268:    TGE  3,4,3	Op >= 
* OP  or
269:     LD  4,-21(1)	Pop left into ac1 
270:     OR  3,4,3	Op | 
* Param  12
271:     ST  3,-21(1)	Push parameter 
* TOFF dec:  -22
* Param end  outputb
272:    LDA  1,-19(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
276:     ST  1,-19(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -20
* TOFF dec:  -21
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >
277:     LD  4,-21(1)	Pop left into ac1 
278:    TGT  3,4,3	Op > 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  <=
279:     LD  4,-21(1)	Pop left into ac1 
280:    TLE  3,4,3	Op <= 
* OP  and
...
* EXPRESSION
* OP  >=
283:     LD  4,-21(1)	Pop left into ac1 
284:    TGE  3,4,3	Op >= 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
285:     LD  4,-21(1)	Pop left into ac1 
286:    TGE  3,4,3	Op >= 
* OP  and
287:     LD  4,-21(1)	Pop left into ac1 
288:    AND  3,4,3	Op & 
* OP  or
289:     LD  4,-21(1)	Pop left into ac1 
290:     OR  3,4,3	Op | 
* Param  13
291:     ST  3,-21(1)	Push parameter 
* TOFF dec:  -22
* Param end  outputb
292:    LDA  1,-19(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
296:     ST  1,-19(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -20
* TOFF dec:  -21
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >
297:     LD  4,-21(1)	Pop left into ac1 
298:    TGT  3,4,3	Op > 
* OP  not
...
* EXPRESSION
* OP  <=
301:     LD  4,-21(1)	Pop left into ac1 
302:    TLE  3,4,3	Op <= 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
303:     LD  4,-21(1)	Pop left into ac1 
304:    TGE  3,4,3	Op >= 
* OP  and
305:     LD  4,-21(1)	Pop left into ac1 
306:    AND  3,4,3	Op & 
* OP  or
307:     LD  4,-21(1)	Pop left into ac1 
308:     OR  3,4,3	Op | 
* Param  14
309:     ST  3,-21(1)	Push parameter 
* TOFF dec:  -22
* Param end  outputb
310:    LDA  1,-19(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
314:     ST  1,-19(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -20
* TOFF dec:  -21
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  >
315:     LD  4,-21(1)	Pop left into ac1 
316:    TGT  3,4,3	Op > 
* OP  not
...
* EXPRESSION
* OP  <=
319:     LD  4,-21(1)	Pop left into ac1 
320:    TLE  3,4,3	Op <= 
* OP  and
321:     LD  4,-21(1)	Pop left into ac1 
322:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  >=
323:     LD  4,-21(1)	Pop left into ac1 
324:    TGE  3,4,3	Op >= 
* OP  or
325:     LD  4,-21(1)	Pop left into ac1 
326:     OR  3,4,3	Op | 
* Param  15
327:     ST  3,-21(1)	Push parameter 
* TOFF dec:  -22
* Param end  outputb
328:    LDA  1,-19(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
332:     ST  1,-19(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -20
* TOFF dec:  -21
* Param end  outnl
333:    LDA  1,-19(1)	Ghost frame becomes new active frame 
