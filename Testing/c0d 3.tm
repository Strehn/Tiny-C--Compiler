...
* EXPRESSION
* CALL  output
 46:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* ASSIGN  -=
...
* EXPRESSION
* CALL  outnl
 54:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
 55:    LDA  1,-6(1)	Ghost frame becomes new active frame 
