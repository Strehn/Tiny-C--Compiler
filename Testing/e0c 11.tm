...
* OP  +
 ...
 68:    ADD  3,4,3	Op + 
* END COMPOUND
 69:    JMP  7,-22(7)	go to beginning of loop 
 70:    JMP  7,15(7)	jump past loop [backpatch] 
* EXPRESSION
* CALL  outnl
 71:     ST  1,-11(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -12
* TOFF dec:  -13
* Param end  outnl
 72:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 76:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* Param  2
 77:     LD  3,-2(1)	Load variable  x
 78:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
 79:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 83:     ST  1,-11(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -12
* TOFF dec:  -13
* Param end  outnl
...
* OP  +
 ...
 91:     ST  3,-12(1)	Push left side 
 92:     LD  4,-12(1)	Pop left into ac1 
 93:    ADD  3,4,3	Op + 
* END COMPOUND
 94:    JMP  7,-22(7)	go to beginning of loop 
 95:    JMP  7,15(7)	jump past loop [backpatch] 
* END COMPOUND
* Add standard closing in case there is no return statement
 96:    LDC  2,0(6)	Set return value to 0 
 97:     LD  3,-1(1)	Load return address 
 98:     LD  1,0(1)	Adjust frame pointer 
 99:    JMP  7,0(3)	Return 
* END FUNCTION main
