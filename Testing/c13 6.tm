...
* ASSIGN  =
 ...
 72:    LDA  5,-1(0)	Load address of base of array x
...
* EXPRESSION
* CALL  outnl
 81:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* OP  (null)
* Param 
 87:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
 88:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 92:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
 97:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
103:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
108:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
109:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
110:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
114:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
115:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* OP  (null)
* Param 
120:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
121:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
125:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
126:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
136:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
137:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
141:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
147:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
152:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
158:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
163:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
169:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
174:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
