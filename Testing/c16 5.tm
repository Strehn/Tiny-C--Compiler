...
* ASSIGN  =
 ...
 47:    LDA  5,-1(1)	Load address of base of array x
 48:    SUB  5,5,4	Compute offset of value 
 49:     ST  3,-5(0)	Store variable x
 50:    LDC  3,73(6)	Load integer constant 
 51:     ST  3,0(1)	Store variable (null)
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  (null)
...
* EXPRESSION
* ASSIGN  =
 52:     ST  3,-6(1)	Push index 
 53:    LDC  3,211(6)	Load integer constant 
 54:     LD  4,-6(1)	Pop index 
 55:    LDA  5,-1(1)	Load address of base of array y
 56:    SUB  5,5,4	Compute offset of value 
 57:     ST  3,-11(0)	Store variable y
 58:    LDC  3,211(6)	Load integer constant 
 59:     ST  3,0(1)	Store variable (null)
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  (null)
...
* EXPRESSION
* CALL  output
 60:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
 62:    LDC  3,31(6)	Load integer constant 
* OP  -
...
* EXPRESSION
* EXPRESSION
 65:    LDC  3,9123(6)	Load integer constant 
* EXPRESSION
* EXPRESSION
 66:    LDC  3,9100(6)	Load integer constant 
* EXPRESSION
 67:    LDC  3,23(6)	Load integer constant 
* OP  +
 68:     LD  4,-9(1)	Pop left into ac1 
 69:    ADD  3,4,3	Op + 
* OP  /
 70:     LD  4,-9(1)	Pop left into ac1 
 71:    DIV  3,4,3	Op / 
* OP  (null)
* OP  +
 72:     LD  4,-9(1)	Pop left into ac1 
 73:    ADD  3,4,3	Op + 
* Param 
...
* EXPRESSION
* CALL  outnl
 79:     ST  1,-7(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* =========================================
* INIT
 88:    LDA  1,-16(0)	Set first frame at end of globals 
