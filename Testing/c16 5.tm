...
* OP  +
 ...
 76:    ADD  3,4,3	Op + 
* OP  /
 77:     LD  4,-12(1)	Pop left into ac1 
 78:    DIV  3,4,3	Op / 
* OP  (null)
* OP  +
 79:     LD  4,-12(1)	Pop left into ac1 
 80:    ADD  3,4,3	Op + 
* Param  0
...
* EXPRESSION
* CALL  outnl
 86:     ST  1,-10(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -11
* TOFF dec:  -12
* Param end  outnl
...
* =========================================
* INIT
 95:    LDA  1,-9(0)	Set first frame at end of globals 
...
100:     ST  3,-4(0)	save size of array y
