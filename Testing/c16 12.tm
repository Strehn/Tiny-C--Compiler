...
* TOFF dec: 
 ...
 64:     ST  3,-8(1)	Push left side 
 65:     LD  4,-9(1)	Pop left into ac1 
 66:    SUB  3,4,3	Compute location from index 
 67:     LD  3,0(3)	Load array element 
 68:     ST  3,0(5)	Push left side 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* EXPRESSION
* EXPRESSION
 69:    LDC  3,33(6)	Load integer constant 
* EXPRESSION
 70:    LDC  3,31(6)	Load integer constant 
* OP  -
 71:     LD  4,-9(1)	Pop left into ac1 
 72:    SUB  3,4,3	Op - 
* OP  (null)
* EXPRESSION
* EXPRESSION
* EXPRESSION
* EXPRESSION
 73:    LDC  3,9123(6)	Load integer constant 
* EXPRESSION
* EXPRESSION
...
* OP  +
 76:     LD  4,-9(1)	Pop left into ac1 
 77:    ADD  3,4,3	Op + 
* OP  /
 78:     LD  4,-9(1)	Pop left into ac1 
 79:    DIV  3,4,3	Op / 
* OP  (null)
* OP  +
 80:     LD  4,-9(1)	Pop left into ac1 
 81:    ADD  3,4,3	Op + 
* Param end  output
