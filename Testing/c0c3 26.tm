...
* EXPRESSION
* ASSIGN  =
 60:     LD  3,-1(0)	Load variable  y
 61:     LD  4,0(0)	Load lhs variable  x
...
* EXPRESSION
* CALL  outputc
 68:     ST  1,-2(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* Param 
 69:     LD  3,0(0)	Load variable  x
...
* EXPRESSION
* CALL  outputc
 75:     ST  1,-2(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* Param 
 76:     LD  3,-1(0)	Load variable  y
...
* EXPRESSION
* CALL  outputc
 82:     ST  1,-2(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* Param 
 83:     LD  3,-2(0)	Load variable  z
...
* EXPRESSION
* CALL  outnl
 89:     ST  1,-2(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  outnl
...
* =========================================
* INIT
 98:    LDA  1,-3(0)	Set first frame at end of globals 
