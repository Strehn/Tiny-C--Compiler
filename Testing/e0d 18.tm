...
* OP  ==
 56:     LD  4,-10(1)	Pop left into ac1 
 57:    TEQ  3,4,3	Op == 
* Break
 58:    JMP  7,-9(7)	break 
* EXPRESSION
...
* OP  +
 ...
 61:     ST  3,-11(1)	Push left side 
 62:     LD  4,-11(1)	Pop left into ac1 
 63:    ADD  3,4,3	Op + 
* END COMPOUND
* EXPRESSION
* CALL  output
 64:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* Param  2
...
* EXPRESSION
* EXPRESSION
 71:    LDC  3,4(6)	Load integer constant 
* OP  ==
...
* OP  +
 ...
 77:     ST  3,-12(1)	Push left side 
 78:     LD  4,-12(1)	Pop left into ac1 
 79:    ADD  3,4,3	Op + 
* END COMPOUND
* END COMPOUND
