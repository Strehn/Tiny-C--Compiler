...
* EXPRESSION
* CALL  output
 44:     ST  1,-12(1)	Store fp in ghost frame for  output
* TOFF dec:  -13
* TOFF dec:  -14
* Here: 
...
* EXPRESSION
* Param end  output
 49:    LDA  1,-12(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 53:     ST  1,-12(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -13
* TOFF dec:  -14
* Param end  outnl
