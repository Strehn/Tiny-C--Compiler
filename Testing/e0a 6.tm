...
* While
 ...
 44:     ST  3,-7(1)	Push left side 
* EXPRESSION
* EXPRESSION
* EXPRESSION
 45:    LDC  3,10(6)	Load integer constant 
* OP  <
 46:     LD  4,-7(1)	Pop left into ac1 
 47:    TLT  3,4,3	Op < 
* COMPOUND
* TOFF set:  -5
* Compound body
...
* EXPRESSION
* CALL  output
 77:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec:  -7
* TOFF dec:  -8
* EXPRESSION
* Param  3
...
* EXPRESSION
* CALL  output
 91:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
 92:    LDC  3,666(6)	Load integer constant 
* Param  4
 93:     ST  3,-9(1)	Push parameter 
* TOFF dec:  -10
* Param end  output
