...
* ASSIGN  =
 ...
 45:    LDA  5,-1(0)	Load address of base of array x
...
* OP  (null)
* EXPRESSION
 48:    LDC  3,73(6)	Load integer constant 
* EXPRESSION
* CALL  output
...
* EXPRESSION
* ASSIGN  =
 62:     ST  3,-5(1)	Push index 
 63:    LDC  3,17(6)	Load integer constant 
 64:     LD  4,-5(1)	Pop index 
 65:    LDA  5,-1(0)	Load address of base of array x
...
* OP  (null)
* EXPRESSION
 68:    LDC  3,17(6)	Load integer constant 
* EXPRESSION
* ASSIGN  =
...
* EXPRESSION
* ASSIGN  =
 71:     ST  3,-6(1)	Push index 
 72:    LDC  3,5(6)	Load integer constant 
 73:     LD  4,-6(1)	Pop index 
 74:    LDA  5,-1(0)	Load address of base of array x
...
* EXPRESSION
* CALL  outnl
 84:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
 85:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 89:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
 90:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
 91:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 95:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
 96:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
100:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
101:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
102:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
106:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
107:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
111:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  output
122:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
123:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
124:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
128:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
133:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
134:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
135:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
139:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
140:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
144:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* OP  (null)
* Param 
145:     ST  3,-8(1)	Push parameter 
* TOFF dec: 
* Param end  output
146:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
150:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
151:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
155:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
161:     ST  1,-6(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
162:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
166:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  output
177:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* TOFF dec: 
* Param end  outnl
184:    LDA  1,-6(1)	Ghost frame becomes new active frame 
