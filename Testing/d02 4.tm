...
* OP  +
 ...
 54:    ADD  3,4,3	Op + 
* Param  1
 55:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
 56:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* OP  +
 66:     LD  4,-10(1)	Pop left into ac1 
 67:    ADD  3,4,3	Op + 
* Param  2
...
* OP  -
 76:     LD  4,-10(1)	Pop left into ac1 
 77:    SUB  3,4,3	Op - 
* EXPRESSION
...
* OP  /
 ...
 93:    DIV  3,4,3	Op / 
* Param  4
 94:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
 95:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 99:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* EXPRESSION
...
107:    MUL  3,4,3	Op * 
* OP  +
108:     LD  4,-10(1)	Pop left into ac1 
109:    ADD  3,4,3	Op + 
* Param  5
110:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
111:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
115:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* EXPRESSION
...
122:    MOD  3,4,3	Op % 
* Param  6
123:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
124:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
128:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* EXPRESSION
...
* OP  *
133:     LD  4,-10(1)	Pop left into ac1 
134:    MUL  3,4,3	Op * 
* OP  +
135:     LD  4,-10(1)	Pop left into ac1 
136:    ADD  3,4,3	Op + 
* Param  7
...
* EXPRESSION
* CALL  outnl
142:     ST  1,-8(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -9
* TOFF dec:  -10
* Param end  outnl
143:    LDA  1,-8(1)	Ghost frame becomes new active frame 
