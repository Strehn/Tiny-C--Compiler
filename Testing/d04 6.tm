...
* OP  or
 ...
 50:     OR  3,4,3	Op | 
* Param  1
 51:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  outputb
 52:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 56:     ST  1,-8(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
 57:     LD  4,-10(1)	Pop left into ac1 
 58:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
 ...
 60:     OR  3,4,3	Op | 
* Param  2
 61:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  outputb
 62:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 66:     ST  1,-8(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* EXPRESSION
...
* OP  or
 ...
 84:     OR  3,4,3	Op | 
* Param  4
 85:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  outputb
 86:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 90:     ST  1,-8(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  or
 95:     LD  4,-10(1)	Pop left into ac1 
 96:     OR  3,4,3	Op | 
* Param  5
 97:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  outputb
 98:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
102:     ST  1,-8(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -9
* TOFF dec:  -10
* Param end  outnl
...
110:     ST  3,-2(1)	Store variable y
* EXPRESSION
* EXPRESSION
* EXPRESSION
* ASSIGN  =
111:    LDC  3,0(6)	Load integer constant 
112:     ST  3,-2(1)	Store variable z
* EXPRESSION
* EXPRESSION
* EXPRESSION
* CALL  outputb
...
* EXPRESSION
* OP  and
114:     LD  4,-13(1)	Pop left into ac1 
115:    AND  3,4,3	Op & 
* OP  or
116:     LD  4,-13(1)	Pop left into ac1 
117:     OR  3,4,3	Op | 
* Param  6
118:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  outputb
119:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
123:     ST  1,-11(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
124:     LD  4,-13(1)	Pop left into ac1 
125:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
126:     LD  4,-13(1)	Pop left into ac1 
127:     OR  3,4,3	Op | 
* Param  7
128:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  outputb
...
* EXPRESSION
* CALL  outputb
133:     ST  1,-11(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
134:     LD  4,-13(1)	Pop left into ac1 
135:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  and
136:     LD  4,-13(1)	Pop left into ac1 
137:    AND  3,4,3	Op & 
* OP  or
138:     LD  4,-13(1)	Pop left into ac1 
139:     OR  3,4,3	Op | 
* Param  8
...
151:     OR  3,4,3	Op | 
* Param  9
152:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  outputb
153:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
157:     ST  1,-11(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
160:     LD  4,-13(1)	Pop left into ac1 
161:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
...
163:     OR  3,4,3	Op | 
* Param  10
164:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  outputb
165:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
169:     ST  1,-11(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -12
* TOFF dec:  -13
* Param end  outnl
170:    LDA  1,-11(1)	Ghost frame becomes new active frame 
