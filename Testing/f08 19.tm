...
* EXPRESSION
* EXPRESSION
 52:    LDC  3,781(6)	Load integer constant 
 53:     ST  3,-4(1)	Push left side 
* EXPRESSION
* CALL  cat
 54:     ST  1,-2(1)	Store fp in ghost frame for  cat
* TOFF dec:  -3
* TOFF dec:  -4
* Param end  cat
...
* TOFF set:  -2
* OP  +
 59:     LD  4,-2(1)	Pop left into ac1 
 60:    ADD  3,4,3	Op + 
* Param  1
 61:     ST  3,-2(1)	Push parameter 
* TOFF dec:  -3
* Param end  output
