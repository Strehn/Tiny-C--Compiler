...
* Break
 64:    JMP  7,-9(7)	break 
* END COMPOUND
 65:    JMP  7,-22(7)	go to beginning of loop 
 66:    JMP  7,15(7)	jump past loop [backpatch] 
* EXPRESSION
* CALL  output
 67:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
 68:    LDC  3,666(6)	Load integer constant 
* Param  2
 69:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
 70:    LDA  1,-8(1)	Ghost frame becomes new active frame 
