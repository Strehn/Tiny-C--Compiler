...
* EXPRESSION
* CALL  outputc
 51:     ST  1,-3(1)	Store fp in ghost frame for  outputc
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* Param 
...
* EXPRESSION
* CALL  outputc
 58:     ST  1,-3(1)	Store fp in ghost frame for  outputc
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* ASSIGN  =
...
* EXPRESSION
* CALL  outputc
 66:     ST  1,-3(1)	Store fp in ghost frame for  outputc
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* Param 
 67:     LD  3,0(1)	Load variable  x
...
* EXPRESSION
* CALL  outputc
 73:     ST  1,-3(1)	Store fp in ghost frame for  outputc
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* Param 
 74:     LD  3,-1(1)	Load variable  y
...
* EXPRESSION
* CALL  outputc
 80:     ST  1,-3(1)	Store fp in ghost frame for  outputc
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* Param 
 81:     LD  3,-2(1)	Load variable  z
...
* =========================================
* INIT
 96:    LDA  1,-3(0)	Set first frame at end of globals 
