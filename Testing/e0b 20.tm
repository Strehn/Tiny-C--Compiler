...
* EXPRESSION
* CALL  output
 53:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
* Param  2
...
* TOFF dec:  -10
* Param end  output
 56:    LDA  1,-7(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 69:     ST  1,-9(1)	Store fp in ghost frame for  output
* TOFF dec:  -10
* TOFF dec:  -11
* EXPRESSION
 70:    LDC  3,666(6)	Load integer constant 
* Param  3
 71:     ST  3,-11(1)	Push parameter 
* TOFF dec:  -12
* Param end  output
 72:    LDA  1,-9(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 79:     ST  1,-10(1)	Store fp in ghost frame for  output
* TOFF dec:  -11
* TOFF dec:  -12
* EXPRESSION
* Param  4
 80:     LD  3,-2(1)	Load variable  x
 81:     ST  3,-12(1)	Push parameter 
* TOFF dec:  -13
* Param end  output
 82:    LDA  1,-10(1)	Ghost frame becomes new active frame 
...
* OP  +
 ...
 90:     LD  4,-11(1)	Pop left into ac1 
 91:    ADD  3,4,3	Op + 
* END COMPOUND
* END COMPOUND
