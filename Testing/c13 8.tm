...
* EXPRESSION
* ASSIGN  =
 61:     ST  3,-3(1)	Push index 
 62:    LDC  3,17(6)	Load integer constant 
 63:     LD  4,-3(1)	Pop index 
...
* EXPRESSION
* CALL  outnl
 81:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  output
119:     ST  1,-3(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
125:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
126:    LDA  1,-3(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
136:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
137:    LDA  1,-3(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
169:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
170:    LDA  1,-3(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
174:     ST  1,-3(1)	Store fp in ghost frame for  output
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
180:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
