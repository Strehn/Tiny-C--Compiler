...
* EXPRESSION
* CALL  outputb
 51:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outputb
 62:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outputb
 73:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
 84:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  outputb
 89:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
 90:    LDC  3,0(6)	Load integer constant 
 91:     ST  3,-5(1)	Push left side 
* EXPRESSION
...
* EXPRESSION
* CALL  outputb
100:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
101:    LDC  3,0(6)	Load integer constant 
102:     ST  3,-5(1)	Push left side 
* EXPRESSION
...
* EXPRESSION
* CALL  outputb
111:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
115:     LD  4,-5(1)	Pop left into ac1 
* OP  and
116:    AND  3,4,3	Op & 
* Param 
117:     ST  3,-5(1)	Push parameter 
* TOFF dec: 
* Param end  outputb
118:    LDA  1,-3(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
122:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* CALL  outnl
133:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* EXPRESSION
* CALL  outputb
149:     ST  1,-3(1)	Store fp in ghost frame for  outputb
* TOFF dec: 
* TOFF dec: 
* EXPRESSION
* EXPRESSION
...
* Param 
155:     ST  3,-5(1)	Push parameter 
* TOFF dec: 
* Param end  outputb
156:    LDA  1,-3(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
160:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
161:    LDA  1,-3(1)	Ghost frame becomes new active frame 
...
* =========================================
* INIT
169:    LDA  1,-16(0)	Set first frame at end of globals 
