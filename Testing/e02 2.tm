...
* EXPRESSION
* CALL  output
 63:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec:  -7
* TOFF dec:  -8
* EXPRESSION
* Param  2
 64:     LD  3,-2(1)	Load variable  x
 65:     ST  3,-8(1)	Push parameter 
* TOFF dec:  -9
* Param end  output
 66:    LDA  1,-6(1)	Ghost frame becomes new active frame 
