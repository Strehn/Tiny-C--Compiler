...
* ASSIGN  =
 ...
 53:    LDA  5,-1(1)	Load address of base of array y
 54:    SUB  5,5,4	Compute offset of value 
 55:     ST  3,-12(1)	Store variable y
* EXPRESSION
* EXPRESSION
* EXPRESSION
...
* ASSIGN  +=
 ...
 61:    LDA  5,-1(1)	Load address of base of array x
 62:    SUB  5,5,4	Compute offset of value 
 63:     ST  3,-4(1)	Store variable x
* EXPRESSION
* EXPRESSION
* EXPRESSION
...
* ASSIGN  -=
 ...
 76:    LDA  5,-1(1)	Load address of base of array y
 77:    SUB  5,5,4	Compute offset of value 
 78:     ST  3,-12(1)	Store variable y
* EXPRESSION
* EXPRESSION
* EXPRESSION
...
* =========================================
* INIT
 97:    LDA  1,10(0)	Set first frame at end of globals 
