...
* TOFF dec:  -10
 ...
 63:    LDA  3,-11(0)	Load address of base of array zz
...
* OP  (null)
* OP  +
 68:     LD  4,-10(1)	Pop left into ac1 
 69:    ADD  3,4,3	Op + 
* Param 
 70:     ST  3,-10(1)	Push parameter 
* TOFF dec: 
* Param end  output
 71:    LDA  1,-8(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
 75:     ST  1,-8(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -9
* TOFF dec:  -10
* Param end  outnl
 76:    LDA  1,-8(1)	Ghost frame becomes new active frame 
