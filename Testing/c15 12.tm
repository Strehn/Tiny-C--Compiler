...
* EXPRESSION
* ASSIGN  =
 44:     ST  3,-3(1)	Push index 
 45:    LDC  3,73(6)	Load integer constant 
 46:     LD  4,-3(1)	Pop index 
...
* TOFF dec: 
 ...
 63:    LDA  3,-1(0)	Load address of base of array zz
...
* EXPRESSION
* CALL  outnl
 75:     ST  1,-3(1)	Store fp in ghost frame for  outnl
* TOFF dec: 
* TOFF dec: 
* Param end  outnl
...
* =========================================
* INIT
 84:    LDA  1,-11(0)	Set first frame at end of globals 
 85:     ST  1,0(1)	Store old fp (point to self) 
* INIT GLOBALS AND STATICS
 86:    LDC  3,3(6)	load size of array x
 87:     ST  3,-4(0)	save size of array x
 88:    LDC  3,4(6)	load size of array y
 89:     ST  3,-10(0)	save size of array y
