...
* EXPRESSION
* CALL  output
 41:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
* Param  1
 42:     LD  3,-2(1)	Load variable  z
 43:     ST  3,-9(1)	Push parameter 
* TOFF dec:  -10
* Param end  output
 44:    LDA  1,-7(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  cat
 54:     ST  1,-7(1)	Store fp in ghost frame for  cat
* TOFF dec:  -8
* TOFF dec:  -9
* Param end  cat
