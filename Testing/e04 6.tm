...
* TOFF dec:  -5
* Param end  output
 98:    LDA  1,-2(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
137:     ST  1,-3(1)	Store fp in ghost frame for  output
* TOFF dec:  -4
* TOFF dec:  -5
* EXPRESSION
...
* EXPRESSION
* CALL  output
161:     ST  1,-3(1)	Store fp in ghost frame for  output
* TOFF dec:  -4
* TOFF dec:  -5
* EXPRESSION
...
* EXPRESSION
* CALL  output
180:     ST  1,-3(1)	Store fp in ghost frame for  output
* TOFF dec:  -4
* TOFF dec:  -5
* EXPRESSION
...
* OP  <
190:     LD  4,-3(1)	Pop left into ac1 
191:    TLT  3,4,3	Op < 
* EXPRESSION
* CALL  output
192:     ST  1,-3(1)	Store fp in ghost frame for  output
* TOFF dec:  -4
* TOFF dec:  -5
* EXPRESSION
193:    LDC  3,211(6)	Load integer constant 
* Param  17
194:     ST  3,-5(1)	Push parameter 
* TOFF dec:  -6
* Param end  output
...
* Param  18
201:     ST  3,-5(1)	Push parameter 
* TOFF dec:  -6
* Param end  output
202:    LDA  1,-3(1)	Ghost frame becomes new active frame 
