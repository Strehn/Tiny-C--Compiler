...
* Param  5
 85:     ST  3,-9(1)	Push parameter 
* TOFF dec:  -10
* Param end  output
 86:    LDA  1,-7(1)	Ghost frame becomes new active frame 
 87:    LDA  3,1(7)	Return address in ac 
 88:    JMP  7,-82(7)	call output
...
* Param  6
 97:     ST  3,-9(1)	Push parameter 
* TOFF dec:  -10
* Param end  output
 98:    LDA  1,-7(1)	Ghost frame becomes new active frame 
 99:    LDA  3,1(7)	Return address in ac 
100:    JMP  7,-94(7)	call output
...
* EXPRESSION
* CALL  output
104:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
...
* EXPRESSION
* CALL  output
120:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
121:    LDC  3,23(6)	Load integer constant 
* Param  9
122:     ST  3,-9(1)	Push parameter 
* TOFF dec:  -10
* Param end  output
123:    LDA  1,-7(1)	Ghost frame becomes new active frame 
124:    LDA  3,1(7)	Return address in ac 
125:    JMP  7,-119(7)	call output
126:    LDA  3,0(2)	save the result in ac 
* Call end  output
* TOFF set:  -7
* EXPRESSION
* CALL  output
127:     ST  1,-7(1)	Store fp in ghost frame for  output
* TOFF dec:  -8
* TOFF dec:  -9
* EXPRESSION
128:    LDC  3,451(6)	Load integer constant 
* Param  10
129:     ST  3,-9(1)	Push parameter 
* TOFF dec:  -10
* Param end  output
130:    LDA  1,-7(1)	Ghost frame becomes new active frame 
131:    LDA  3,1(7)	Return address in ac 
132:    JMP  7,-126(7)	call output
...
* EXPRESSION
* CALL  output
137:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
138:    LDC  3,44(6)	Load integer constant 
* Param  11
139:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
140:    LDA  1,-8(1)	Ghost frame becomes new active frame 
141:    LDA  3,1(7)	Return address in ac 
142:    JMP  7,-136(7)	call output
143:    LDA  3,0(2)	save the result in ac 
* Call end  output
* TOFF set:  -8
* EXPRESSION
* CALL  output
144:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
145:    LDC  3,514(6)	Load integer constant 
* Param  12
146:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
147:    LDA  1,-8(1)	Ghost frame becomes new active frame 
148:    LDA  3,1(7)	Return address in ac 
149:    JMP  7,-143(7)	call output
...
159:    JMP  7,-153(7)	call output
160:    LDA  3,0(2)	save the result in ac 
* Call end  output
* TOFF set:  -8
* EXPRESSION
* CALL  output
161:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
162:    LDC  3,1514(6)	Load integer constant 
* Param  14
163:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
164:    LDA  1,-8(1)	Ghost frame becomes new active frame 
165:    LDA  3,1(7)	Return address in ac 
166:    JMP  7,-160(7)	call output
...
* OP  >
171:     LD  4,-8(1)	Pop left into ac1 
172:    TGT  3,4,3	Op > 
* EXPRESSION
* CALL  output
...
* EXPRESSION
* CALL  output
192:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
193:    LDC  3,211(6)	Load integer constant 
* Param  17
194:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
195:    LDA  1,-8(1)	Ghost frame becomes new active frame 
196:    LDA  3,1(7)	Return address in ac 
197:    JMP  7,-191(7)	call output
198:    LDA  3,0(2)	save the result in ac 
* Call end  output
* TOFF set:  -8
* EXPRESSION
* CALL  output
199:     ST  1,-8(1)	Store fp in ghost frame for  output
* TOFF dec:  -9
* TOFF dec:  -10
* EXPRESSION
200:    LDC  3,1614(6)	Load integer constant 
* Param  18
201:     ST  3,-10(1)	Push parameter 
* TOFF dec:  -11
* Param end  output
202:    LDA  1,-8(1)	Ghost frame becomes new active frame 
203:    LDA  3,1(7)	Return address in ac 
204:    JMP  7,-198(7)	call output
