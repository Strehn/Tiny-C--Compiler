...
* OP  or
 ...
 50:     OR  3,4,3	Op | 
* Param  1
 51:     ST  3,-11(1)	Push parameter 
* TOFF dec:  -12
* Param end  outputb
 52:    LDA  1,-9(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 56:     ST  1,-9(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -10
* TOFF dec:  -11
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
 57:     LD  4,-11(1)	Pop left into ac1 
 58:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
 59:     LD  4,-11(1)	Pop left into ac1 
 60:     OR  3,4,3	Op | 
* Param  2
 61:     ST  3,-11(1)	Push parameter 
* TOFF dec:  -12
* Param end  outputb
 62:    LDA  1,-9(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 66:     ST  1,-9(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -10
* TOFF dec:  -11
* EXPRESSION
* EXPRESSION
...
* OP  or
 ...
 84:     OR  3,4,3	Op | 
* Param  4
 85:     ST  3,-11(1)	Push parameter 
* TOFF dec:  -12
* Param end  outputb
 86:    LDA  1,-9(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
 90:     ST  1,-9(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -10
* TOFF dec:  -11
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
 93:     LD  4,-11(1)	Pop left into ac1 
 94:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
...
* EXPRESSION
* CALL  outnl
102:     ST  1,-9(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -10
* TOFF dec:  -11
* Param end  outnl
103:    LDA  1,-9(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
113:     ST  1,-12(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -13
* TOFF dec:  -14
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
114:     LD  4,-14(1)	Pop left into ac1 
115:    AND  3,4,3	Op & 
* OP  or
116:     LD  4,-14(1)	Pop left into ac1 
117:     OR  3,4,3	Op | 
* Param  6
118:     ST  3,-14(1)	Push parameter 
* TOFF dec:  -15
* Param end  outputb
119:    LDA  1,-12(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
123:     ST  1,-12(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -13
* TOFF dec:  -14
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
124:     LD  4,-14(1)	Pop left into ac1 
125:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
126:     LD  4,-14(1)	Pop left into ac1 
127:     OR  3,4,3	Op | 
* Param  7
128:     ST  3,-14(1)	Push parameter 
* TOFF dec:  -15
* Param end  outputb
129:    LDA  1,-12(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
133:     ST  1,-12(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -13
* TOFF dec:  -14
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
134:     LD  4,-14(1)	Pop left into ac1 
135:    AND  3,4,3	Op & 
* EXPRESSION
* EXPRESSION
* EXPRESSION
* OP  and
136:     LD  4,-14(1)	Pop left into ac1 
137:    AND  3,4,3	Op & 
* OP  or
138:     LD  4,-14(1)	Pop left into ac1 
139:     OR  3,4,3	Op | 
* Param  8
140:     ST  3,-14(1)	Push parameter 
* TOFF dec:  -15
* Param end  outputb
141:    LDA  1,-12(1)	Ghost frame becomes new active frame 
...
151:     OR  3,4,3	Op | 
* Param  9
152:     ST  3,-14(1)	Push parameter 
* TOFF dec:  -15
* Param end  outputb
153:    LDA  1,-12(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outputb
157:     ST  1,-12(1)	Store fp in ghost frame for  outputb
* TOFF dec:  -13
* TOFF dec:  -14
* EXPRESSION
* EXPRESSION
...
* EXPRESSION
* OP  and
160:     LD  4,-14(1)	Pop left into ac1 
161:    AND  3,4,3	Op & 
* EXPRESSION
* OP  or
...
163:     OR  3,4,3	Op | 
* Param  10
164:     ST  3,-14(1)	Push parameter 
* TOFF dec:  -15
* Param end  outputb
165:    LDA  1,-12(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
169:     ST  1,-12(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -13
* TOFF dec:  -14
* Param end  outnl
170:    LDA  1,-12(1)	Ghost frame becomes new active frame 
