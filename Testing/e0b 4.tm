...
* EXPRESSION
* CALL  output
 43:     ST  1,-6(1)	Store fp in ghost frame for  output
* TOFF dec:  -7
* TOFF dec:  -8
* EXPRESSION
 44:    LDC  3,666(6)	Load integer constant 
* Param  1
 45:     ST  3,-8(1)	Push parameter 
* TOFF dec:  -9
* Param end  output
 46:    LDA  1,-6(1)	Ghost frame becomes new active frame 
...
* While
 ...
 80:     ST  3,-2(1)	Push left side 
* EXPRESSION
* EXPRESSION
* EXPRESSION
 81:    LDC  3,10(6)	Load integer constant 
* OP  <
 82:     LD  4,-2(1)	Pop left into ac1 
 83:    TLT  3,4,3	Op < 
* COMPOUND
* TOFF set:  -5
* Compound body
* EXPRESSION
* CALL  output
 84:     ST  1,-5(1)	Store fp in ghost frame for  output
* TOFF dec:  -6
* TOFF dec:  -7
* EXPRESSION
* Param  4
