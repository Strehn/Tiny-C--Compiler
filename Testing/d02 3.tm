...
* OP  +
 66:     LD  4,-13(1)	Pop left into ac1 
 67:    ADD  3,4,3	Op + 
* Param  2
 68:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
 69:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* OP  -
 76:     LD  4,-13(1)	Pop left into ac1 
 77:    SUB  3,4,3	Op - 
* EXPRESSION
...
* EXPRESSION
* CALL  output
 86:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* OP  /
 ...
 93:    DIV  3,4,3	Op / 
* Param  4
 94:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
 95:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  output
 99:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* OP  %
118:     LD  4,-13(1)	Pop left into ac1 
119:    MOD  3,4,3	Op % 
* EXPRESSION
...
* EXPRESSION
* CALL  output
128:     ST  1,-11(1)	Store fp in ghost frame for  output
* TOFF dec:  -12
* TOFF dec:  -13
* EXPRESSION
* EXPRESSION
...
* OP  *
133:     LD  4,-13(1)	Pop left into ac1 
134:    MUL  3,4,3	Op * 
* OP  +
135:     LD  4,-13(1)	Pop left into ac1 
136:    ADD  3,4,3	Op + 
* Param  7
137:     ST  3,-13(1)	Push parameter 
* TOFF dec:  -14
* Param end  output
138:    LDA  1,-11(1)	Ghost frame becomes new active frame 
...
* EXPRESSION
* CALL  outnl
142:     ST  1,-11(1)	Store fp in ghost frame for  outnl
* TOFF dec:  -12
* TOFF dec:  -13
* Param end  outnl
143:    LDA  1,-11(1)	Ghost frame becomes new active frame 
