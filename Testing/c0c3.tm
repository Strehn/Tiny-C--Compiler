...
* EXPRESSION
* CALL  outputc
 71:     ST  1,-2(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* Param 
 72:     LD  3,0(0)	Load variable  x
...
* EXPRESSION
* CALL  outputc
 78:     ST  1,-2(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* Param 
 79:     LD  3,-1(0)	Load variable  y
...
* EXPRESSION
* CALL  outputc
 85:     ST  1,-2(1)	Store fp in ghost frame for  outputc
* TOFF dec:  -3
* TOFF dec:  -4
* EXPRESSION
* Param 
 86:     LD  3,-2(0)	Load variable  z
